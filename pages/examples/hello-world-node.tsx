      ...
      <main className={styles.main}>
        <div style={{ maxWidth: "800px" }}>
          ...
          <ol>
            ...
            <li>
              Run pm2 startup script: This will daemonize pm2 and initialize it
              on system reboots.
            ...
            <li>
              <code>
                [ec2-user@ip-XX-XXX-XX-X ~]$ sudo iptables -t nat -A PREROUTING
                -p tcp --dport 80 -j REDIRECT --to-ports 8000
              </code>
              and then list again
              <code>[ec2-user@ip-XX-XXX-XX-X ~]$ sudo iptables -t nat -L</code>
            </li>
